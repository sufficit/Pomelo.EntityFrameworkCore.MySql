...
public class TPCManyToManyQueryMySqlTest : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQueryMySqlFixture>
{
    public TPCManyToManyQueryMySqlTest(TPCManyToManyQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
